...
function clonarDatos(data: IDataProductos): IDataProductos {
  return {
...
export function actualizarDatosProductos(transformer: (datos: IDataProductos) => IDataProductos): IDataProductos {
